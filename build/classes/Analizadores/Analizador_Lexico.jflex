...
comentarioencerrado = "<!" ({cualquiercaracter}|{LineTerminator})* "!>"
...
{Tk_CONJ}        { System.out.println("Reconocio "+yytext()+" Tk_CONJ"); return new Symbol(Simbolos.Tk_CONJ, yycolumn, yyline, yytext());}
